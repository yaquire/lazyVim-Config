...
complete -c dmidecode -l list-strings -d 'List available string keywords, which can then be passed to the --string opti…'
complete -c dmidecode -s t -l type -d 'Only display the entries of type TYPE'
complete -c dmidecode -l list-types -d 'List available type keywords, which can then be passed to the --type option'
