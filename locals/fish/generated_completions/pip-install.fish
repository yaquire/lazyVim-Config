...
complete -c pip-install -l progress-bar -d 'Specify whether the progress bar should be used [on, off, raw] (default: on) '
complete -c pip-install -l root-user-action -d 'Action if pip is run as a root user [warn, ignore] (default: warn) '
complete -c pip-install -l report -d 'Generate a JSON file describing what pip did to install the provided requirem…'
complete -c pip-install -l no-clean -d 'Don\'t clean up build directories. sp (environment variable: PIP_NO_CLEAN)'
